...
const submitBackgroundSurvey = (event) => {
    ...
    background['departmentField'] = getRadioButtonValue("department_radio")
    background['isTenureTrackFaculty'] = getRadioButtonValue("tt_radio")
    background['comfortWithStats'] = getRadioButtonValue("comfort_with_stats_radio")
    background['comfortWithData'] = getRadioButtonValue("comfort_with_data_radio")
    background['taughtStats'] = getRadioButtonValue("taught_stats_radio")
    background['papersReviewed'] = getRadioButtonValue("papers_reviewed_radio")
